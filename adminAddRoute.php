        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="adminAddRoute.php" class="nav-link active">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="system/addRoute.php" method="POST">
                                        <fieldset>
                                            <div class="row my-4">
                                                <div class="col-5 col-sm-5 col-lg-5 col-xl-5 col-xxl-5">
                                                    <input type="text" name="routeStart" id="route-start"
                                                        placeholder="ต้นทาง"
                                                        class="bg-dark w-100 py-2 border border-light rounded-pill px-3 text-dark">
                                                </div>
                                                <div class="col-5 col-sm-5 col-lg-5 col-xl-5 col-xxl-5">
                                                    <input type="text" name="routeDes" id="route-start"
                                                        placeholder="ปลายทาง"
                                                        class="bg-dark w-100 py-2 border border-light rounded-pill px-3 text-dark">
                                                </div>
                                                <div class="col-2 col-sm-2 col-lg-2 col-xl-2 col-xxl-2">
                                                    <input type="text" name="routePrice" id="route-start"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="exampleFormControlTextarea1"
                                                    rows="3" name="route_detail"></textarea>
                                            </div>
